return {
  ...
  },
  {
    ...
    keys = {
      --stylua: ignore
      { "<leader>cot", "<cmd>AerialToggle", desc = "Open/Close the Aerial Window", },
      { "<leader>con", "<cmd>AerialNext", desc = "Jump forwards 1 symbol" },
      { "<leader>cop", "<cmd>AerialPrev", desc = "Jump backwards 1 symbol" },
    },
  },
  {
    "ahmedkhalf/project.nvim",
